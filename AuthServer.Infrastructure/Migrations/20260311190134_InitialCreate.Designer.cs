...
namespace AuthServer.Infrastructure.Migrations
{
    ...
    [Migration("20260311190134_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthServer.Domain.Entities.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AuthServer.Domain.Entities.EmailLoginCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("EmailLoginCodes", (string)null);
                });

            modelBuilder.Entity("AuthServer.Domain.Entities.PersonalDataExport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PersonalDataExports", (string)null);
                });

            modelBuilder.Entity("AuthServer.Domain.Entities.UserPasskey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("AuthServer.Domain.Entities.ApplicationRole", null)
                        .WithMany()
